        ...
        fields: [
          // ——— Hero ———
          {
            ...
            fields: [
              ...
              { type: "image", name: "sceneImage", label: "Scene photo (wide, behind the headline)" },
              { type: "string", name: "sceneImageAlt", label: "Scene photo description" },
              { type: "string", name: "sceneCredit", label: "Photo credit line" },
              { type: "string", name: "athletesEyebrow", label: "Small line above the athlete cards" },
              {
                type: "object",
                name: "athletes",
                label: "Athlete cards",
