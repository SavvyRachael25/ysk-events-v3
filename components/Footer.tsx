    ...
    <footer className="border-t border-paper/10 bg-ink text-paper">
      ...
      <div className="mx-auto max-w-[1280px] px-6 py-16 md:px-12 md:py-20">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-5">
            ...
            <p className="mt-6 max-w-[380px] font-sans text-sm leading-relaxed text-paper/55">
              ...
              Seattle, Washington, June 6 to 10, 2028. Presented by YSK Events, a
          ...
          <nav aria-label="Footer" className="md:col-span-3">
            ...
            <ul className="mt-4 space-y-1">
              {[...NAV_SECTIONS, { id: "squash-art", label: "Squash Art", href: "/squash-art" }, { id: "press", label: "Press", href: "/press" }].map((s) => (
                <li key={s.id}>
                  <a
                    href={s.href}
        ...
        <details className="group mt-12 max-w-[820px] border-t border-paper/15 pt-5 font-sans text-[13px] leading-relaxed text-paper/70">
          ...
          <p>
            Player photographs by Nettrom, 2023-24 PSA World Tour Finals, Bellevue, via Wikimedia Commons,
            licensed{" "}
            ...
            ). Cropped and scaled for display, and a second player and a reflection on the glass were removed from one of them; these versions are shared under the same licence. Universal Studios
            ...
            <a href="https://commons.wikimedia.org/wiki/File:Seattle_Skyline_Kerry_Park.jpg" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-white">CC BY-SA 4.0</a>, cropped, with a squash court floor added in front of it in one version. Bellevue skyline by Matthew Rutledge,{" "}
