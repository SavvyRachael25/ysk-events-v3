...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    body: [
      ...
      },
      {
        type: "ul",
        items: [
          "Community Clinics, free for ages 5 to 18. No experience or equipment needed. We loan rackets and eyewear at the door.",
      ...
      {
        type: "p",
        text: "Squash makes its Olympic debut at the Los Angeles 2028 Games. For an 11-year-old in 2026, LA28 is a stretch but not an impossibility. The U.S. team will be small, but it will be real. For a 7-year-old, the 2032 and 2036 Games are realistic horizon points if the kid loves the sport.",
      },
      {
        type: "p",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "No. YSK Events programs welcome non-members, and our scholarship-funded spots are specifically designed for families without club access. Our flagship training facility is PRO Club Bellevue, but we also coach at partner facilities across the Seattle to Bellevue corridor.",
      },
      {
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        text: "Squash at LA28 will field men's and women's singles. The U.S. team will be small, but it's the first one. For a junior who is already nationally ranked, the 2032 and 2036 Games become realistic horizon points. For a junior just starting, this is the best moment in U.S. squash history to begin.",
      },
      {
        type: "h2",
      ...
      {
        type: "p",
        text: "If your child is already a tournament-level junior, the playbook for 2026 to 2028 is fairly settled:",
      },
      {
        type: "ul",
        items: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Olympic squash qualification combines world ranking, regional championship performance, and host-nation allocation, administered by the World Squash Federation in coordination with US Squash. Final 2028 quotas and criteria are still being finalized.",
      },
      {
        question: "Is it too late for a 13-year-old to start squash and aim for the Olympics?",
        answer:
          "Realistically, LA28 itself is unlikely for a 13-year-old just beginning. The 2032 and 2036 Games are reasonable horizon points for a committed player. Because the U.S. squash player pool is still small, late starters who train seriously can reach national-ranked play within a few years.",
      },
      {
        question: "What's the LA28 Pathway program at YSK Events?",
        answer:
          "The LA28 Pathway is a developmental track for Pacific Northwest juniors with Olympic potential, launching in 2027. It's a structured progression within our existing youth ecosystem, beginning at Community Clinics, advancing through Competitive Training, and into US Squash to sanctioned national competition.",
      },
      {
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "h2",
        text: "2013 to today: from professional events to youth development",
        id: "youth-pivot",
      },
      {
        type: "p",
      ...
      },
      {
        ...
        items: [
          ...
          "Community Clinics, free introductory clinics for ages 5 to 18, with scholarship-funded access for underserved families.",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "YSK Events has shifted its strategic priority toward youth development since 2013, with a deepening focus after 2015. The organization continues to host professional showcases, including the Yusuf Khan Invitational under Murad Khan's leadership, but in June 2028 YSK presents the final Olympic qualification event for squash in Bellevue and Seattle, the last stop before the sport's Olympic debut at Los Angeles 2028.",
      },
    ],
  },
];
